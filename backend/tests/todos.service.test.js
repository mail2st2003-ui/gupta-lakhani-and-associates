...
const todos_service_1 = require("../src/services/todos.service");
const todos_repository_1 = require("../src/repositories/todos.repository");
jest.mock('../src/repositories/todos.repository');
describe('TodosService', () => {
    let todosService;
    let mockTodosRepository;
    beforeEach(() => {
        mockTodosRepository = new todos_repository_1.TodosRepository();
        todosService = new todos_service_1.TodosService();
        // Inject mock repository
        todosService.todosRepository = mockTodosRepository;
        jest.clearAllMocks();
    ...
    describe('deleteTodo', () => {
        it('should call repository delete', async () => {
            mockTodosRepository.deleteTodo.mockResolvedValue({ success: true });
